...
export function PlaceholdersAndVanishInput({
  ...
  return (
    <form
      className={cn(
        "relative mx-auto h-12 w-full max-w-xl overflow-hidden rounded-full bg-white -[0px_2px_3px_-1px_rgba(0,0,0,0.1),_0px_1px_0px_0px_rgba(25,28,33,0.02),_0px_0px_0px_1px_rgba(25,28,33,0.08)] transitioshadown duration-200 dark:bg-zinc-800",
        value && "bg-gray-50",
      )}
