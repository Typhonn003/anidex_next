...
export const AuroraBackground = ({
  ...
  return (
    <main>
      <div
        className={cn(
          "transition-bg relative flex h-[calc(100vh-2.5625rem)] flex-col items-center justify-center bg-zinc-50 text-slate-950 md:h-[calc(100vh-1px)] dark:bg-zinc-900",
          className,
        )}
        {...props}
      >
