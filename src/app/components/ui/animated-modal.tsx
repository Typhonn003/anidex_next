      ...
      {genreModal && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "relative z-50 mx-4 flex max-h-[90%] min-h-[50%] max-w-96 flex-1 flex-col overflow-hidden rounded-2xl border border-transparent bg-white md:max-w-[580px] dark:border-neutral-800 dark:bg-neutral-950",
              className,
            )}
            initial={{
              opacity: 0,
